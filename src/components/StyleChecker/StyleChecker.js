...
const styleChecker = () => {
  return (
    <div id="top" role="document" className="prose prose-sm">
      <header role="banner">
        ...
        <section id="embedded">
          ...
          <article id="embedded__images">
            ...
            <div>
              ...
              <p><img src="http://placekitten.com/480/480" alt="alt text img1" /></p>
              <h3>Wrapped in a <code>&lt;figure&gt;</code> element, no <code>&lt;figcaption&gt;</code></h3>
              <figure><img src="http://placekitten.com/420/420" alt="alt text img2" /></figure>
              <h3>Wrapped in a <code>&lt;figure&gt;</code> element, with a <code>&lt;figcaption&gt;</code></h3>
              <figure>
                <img src="http://placekitten.com/420/420" alt="alt text img3" />
          ...
          <article id="embedded__iframe">
            ...
            <div><iframe src="index.html" height="300" title="iframe"></iframe></div>
            <footer>
              <p><a href="#top">[Top]</a></p>
            </footer>
          </article>
